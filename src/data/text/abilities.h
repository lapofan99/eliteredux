...
static const u8 sPlusDescription[] = _("Powers up 50% with Plus/Minus.");
static const u8 sMinusDescription[] = _("Powers up 50% with Plus/Minus.");
...
static const u8 sSapSipperDescription[] = _("Grass increases Attack by +1.");
