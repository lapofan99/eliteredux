...
static const u8 sIlluminateDescription[] = _("20% accuracy boost.");
...
static const u8 sVictoryStarDescription[] = _("Raises accuracy by 20%\nfor itself and allies.");
...
static const u8 sSurgeSurferDescription[] = _("Doubles Speed on Electric Terrain.\nWorks while levitating.");
