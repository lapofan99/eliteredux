...
static const u8 sCompetitiveDescription[] = _("Lowered stats up Sp. Atk +2.");
...
static const u8 sMercilessDescription[] = _("Criticals poisoned and\nspeed-reduced foes.");
...
static const u8 sCorrosionDescription[] = _("Super-effective to Steel\nand poisons any type.");
...
static const u8 sCoilUpDescription[] =  _("Coils when sent out. Biting\nmoves priority +1 first turn.");
...
static const u8 sHypnotistDescription[] = _("Increases Hypnosis accuracy\nby 50%.");
...
static const u8 sMultiHeadedDescription[] =  _("Two heads hit twice,\nthree heads three times");
