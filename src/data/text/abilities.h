...
static const u8 sStaticDescription[] = _("30% chance to paralyze on contact.");
...
static const u8 sNocturnalDescription[] = _("Dark-type at night, then boosts\nOffense by 10% and Speed by 20%.");
