...
static const u8 sCoilUpDescription[] =  _("Biting moves have +1 prio once.\nDoubles moves like Rollout etc.");
...
static const u8 sDreamcatcherDescription[] = _("Boosts power of moves by 50%\nwhen someone is asleep.");
