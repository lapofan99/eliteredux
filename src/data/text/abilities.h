...
static const u8 sCompoundEyesDescription[] = _("Raises accuracy by 1.3x.");
...
static const u8 sGutsDescription[] = _("Ups Attack by 1.5x\nif suffering.");
static const u8 sMarvelScaleDescription[] = _("Ups Defense by 1.5x\nif suffering.");
...
static const u8 sRivalryDescription[] = _("Powers up 1.25x against rivals.");
...
static const u8 sTechnicianDescription[] = _("Boosts weaker moves by 50%.");
...
static const u8 sSlowStartDescription[] = _("Takes 5 turns to get going.");
...
static const u8 sVictoryStarDescription[] = _("Raises party accuracy by 10%.");
...
static const u8 sMegaLauncherDescription[] = _("Boosts pulse moves by 50%.");
...
static const u8 sStakeoutDescription[] = _("Does 2x damage on\nfoes switching in.");
static const u8 sWaterBubbleDescription[] = _("Halves fire damage\nand prevents burns.");
...
static const u8 sAerodynamicsDescription[] = _("Getting hit by Flying moves\nraises Speed instead.");
...
static const u8 sAvengerDescription[] =  _("Hits 30% harder if an ally\nfainted last turn.");
static const u8 sLetsRollDescription[] =  _("Curls when sent out.");
static const u8 sAquaticDescription[] =  _("Adds Water-Type.");
static const u8 sLoudBangDescription[] =  _("Sound moves have 10% chance\nto confuse the foe.");
...
static const u8 sFossilizedDescription[] = _("Reduces Rock-type damage by 50%");
...
static const u8 sMountaineerDescription[] =  _("Avoids Rock-type and\nStealth Rock Damage.");
...
static const u8 sOverchargeDescription[] =  _("Electric does 2x dmg to Electr.\nCan paralyze Electric.");
...
static const u8 sSolarFlareDescription[] =  _("Fire-type moves gain STAB.\nBetter Solar moves and Morning Sun.");
static const u8 sPowerCoreDescription[] =  _("The Pokémon uses +25% of its\nDefense/SpDef stats during moves.");
static const u8 sSightingSystemDescription[] =  _("<=50% acc moves> moves always\nhit but priority is lower.");
