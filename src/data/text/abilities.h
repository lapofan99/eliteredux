...
static const u8 sLowBlowDescription[]    = _("Lands a low-power punching\nmove on switch-in.");
...
static const u8 sLethargyDescription[] = _("Atk is lowered by 20% at the\nend of turn, until 20%.");
...
static const u8 sAtomicBurstDescription[]     = _("When hit by a super effective\nmove triggers a 50 BP Hyper Beam.");
...
const u8 gAbilityNames[ABILITIES_COUNT][ABILITY_NAME_LENGTH + 1] =
{
    ...
    [ABILITY_RETRIBUTION_BLOW] = _("Atomic Burst"),
    ...
    [ABILITY_ATOMIC_BURST] = _("Atomic Clone"),
