...
static const u8 sChlorophyllDescription[] = _("Double Speed in sunshine.");
...
static const u8 sGutsDescription[] = _("Ups Attack 1.5x if suffering.");
static const u8 sMarvelScaleDescription[] = _("Ups Defense 1.5x if suffering.");
...
static const u8 sPerfectionistDescription[] = _("+1 crit to moves <40 BP.\n+1 crit & +1 prio for <20 BP");
