const u32 *const gItemIconTable[][2] =
{
    ...
    // Mail
    [ITEM_NIDOQUEENITE] = {gItemIcon_OrangeMail, gItemIconPalette_OrangeMail},
    [ITEM_NIDOKINGITE] = {gItemIcon_HarborMail, gItemIconPalette_HarborMail},
    [ITEM_SANDSLASHITE] = {gItemIcon_GlitterMail, gItemIconPalette_GlitterMail},
    [ITEM_MEGANIUMITE] = {gItemIcon_MechMail, gItemIconPalette_MechMail},
