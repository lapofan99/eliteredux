...
static const u8 sText_PkmnsXMadeYIneffective[] = _("{B_DEF_NAME_WITH_PREFIX}'s Sticky Hold\nmade {B_CURRENT_MOVE} ineffective!");
...
static const u8 sText_AbilityRaisedStatDrastically[] = _("{B_DEF_NAME_WITH_PREFIX}'s ability raised its\n{B_BUFF1} drastically!");
...
static const u8 sText_PkmnDidAmmountDamage[] = _("{B_ACTIVE_NAME_WITH_PREFIX} did {B_BUFF3} Damage!");
