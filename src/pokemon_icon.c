...
const u8 *const gMonIconTable[] =
{
    ...
    [SPECIES_HITMONCHAN_MEGA] = gMonIcon_Hitmonchan,
    [SPECIES_HITMONTOP_MEGA] = gMonIcon_Hitmontop,
    [SPECIES_CROBAT_MEGA] = gMonIcon_Crobat,
    [SPECIES_SKARMORY_MEGA] = gMonIcon_Skarmory,
    [SPECIES_BRUXISH_MEGA] = gMonIcon_Bruxish,
    [SPECIES_TORTERRA_MEGA] = gMonIcon_Torterra,
    [SPECIES_INFERNAPE_MEGA] = gMonIcon_Infernape,
    [SPECIES_EMPOLEON_MEGA] = gMonIcon_Empoleon,
    [SPECIES_SHUCKLE_MEGA] = gMonIcon_Shuckle,
    [SPECIES_RELICANTH_MEGA] = gMonIcon_Relicanth,
    [SPECIES_QUAGSIRE_MEGA] = gMonIcon_Quagsire,
    [SPECIES_JELLICENT_MEGA] = gMonIcon_Jellicent,
    [SPECIES_TOUCANNON_MEGA] = gMonIcon_Toucannon,
