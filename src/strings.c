...
const u8 gText_BirchNormalMode[] = _("Easy"); // was Normal
const u8 gText_BirchHardMode[] = _("Normal"); // was Hard, unused
const u8 gText_BirchChallengeMode[] = _("Elite"); // was Challenge
...
const u8 gText_Sound[] = _("Permanent Repel");
...
const u8 gText_SavingNormalMode[] = _("Easy Mode"); // was Normal
const u8 gText_SavingHardMode[] = _("Normal Mode"); // was Hard, not used anymore
const u8 gText_SavingChallengeMode[] = _("Elite Mode"); // was Challenge
const u8 gText_SavingInsanityMode[] = _("Insanity Mode"); // not used
const u8 gText_SavingVersionNum[] = _("Ver 0.9");
